...
<div class="row flex justify-content-center">
	<div class="col-8">
		<div class="card">
			<div class="container">
				<div class="row">
					<span class="col" style="margin-top: 1rem">
						<label class="title"> <%= h.changeCase.ucFirst(h.changeCase.camel(name)) %> Table </label>
					</span>
					<span class="col d-flex justify-content-end m-2">
						<button
							pButton
							pRipple
							type="button"
